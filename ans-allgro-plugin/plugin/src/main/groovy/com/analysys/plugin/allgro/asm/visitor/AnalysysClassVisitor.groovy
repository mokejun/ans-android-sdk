...
import com.analysys.plugin.allgro.AnalysysConstants
...
//                println("SDK_VER=${version}")
                if (AnalysysConstants.MIN_SDK_VER > version) {
                    String errMessage = "当前 SDK 版本 v${version}，请升级到 v${AnalysysConstants.MIN_SDK_VER} 及以上版本。"
...
//                println("MIN_PLUGIN_VER=${minPluginVersion}")
                if (minPluginVersion != "" && minPluginVersion != null) {
                    String ver = AnalysysConstants.PLUGIN_VER
                    if (AnalysysConstants.PLUGIN_VER < minPluginVersion) {
